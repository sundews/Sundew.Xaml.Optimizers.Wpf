        ...
        if (resourceDictionaryElement.Name == frameworkResourceDictionaryName)
        {
            ...
            if (optimizationMapping != null)
            {
                ...
                return optimizationMapping.Action switch
                {
                    ...
                    OptimizationAction.Replace => new OptimizationInfo(OptimizationAction.Replace, XamlType.TryParse(optimizationMapping.ReplacementType) ?? defaultReplacementType, sourceAttribute.Value),
