// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataBinding.cs" company="Sundews">
    ...
    where TTarget : DependencyObject
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DataBinding{TRoot, TSource,TSourceValue,TTarget,TTargetValue}" /> class.
    /// </summary>
